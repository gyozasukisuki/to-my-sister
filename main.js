...
function checkMassage(name){
    if(name === "SS"){
        ...
        return "勉強もクラブも<br class='changeline'>悔いのないように<br class='changeline'>毎日を過ごしてね!<br class='changeline'>そしてパパたちを<br class='changeline'>東京ドームに連れてっておくれ。<br class='changeline'>あ、誕生日おめでとう!";
    }
}
